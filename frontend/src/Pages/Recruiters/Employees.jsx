                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                          {employee.employeeCode || "No code"} · Start: {formatDate(employee.startDate)}
                        </p>
                      </div>
                      <select
                  ...
                  {attendance.map((record) => (
                    <div key={record.id} className="px-5 py-4 flex items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{formatDate(record.workDate)} · {record.checkIn || "--"} - {record.checkOut || "--"}</p>
                      </div>
                ...
                {leaveRequests.map((request) => (
                  <div key={request.id} className="px-5 py-4 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">{formatDate(request.startDate)} - {formatDate(request.endDate)}</p>
